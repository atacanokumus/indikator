...
export const metadata: Metadata = {
    title: "Hakkımızda",
    description: "ECOTUBE nedir, nasıl çalışır, veriler nereden gelir ve neyi vaat etmez.",
    ...
    return (
        <article className="wrap section" style={{ maxWidth: 720 }}>
            ...
            <p className="lead" style={{ marginTop: 16 }}>
                ECOTUBE, Türkiye&apos;deki YouTube ekonomi yorumcularının ne dediğini takip etmeyi
            ...
            <p className="small">
                ...
                Cevabı bulmak içinse onlarca kanalda, saatlerce video izlemek gerekir. ECOTUBE bu işi
            ...
            <p className="small">
                ECOTUBE yatırım tavsiyesi vermez, portföy önermez, alım satım yapmaz ve hiçbir yorumcuyu
            ...
            <p className="small">
                Kanalınızın ECOTUBE&apos;da yer almasını istemiyorsanız veya bir sinyalin videonuzu yanlış
